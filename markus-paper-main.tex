...
MarkUs takes into account the needs expressed by teachers and students. A single web-application, its primary features follow:
\begin{itemize}
...
Additional features are described in section~\ref{features}.
