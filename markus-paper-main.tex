...
course: group creation, code viewer with syntax highlighting, marking
schemes, annotations. After 2 years of development, the project suffered from
a poor quality code base and a lack of testing: integrating new features had
become a burden.

In 2008, it was decided to rewrite the whole application in Ruby on Rails. OLM
was reborned into MarkUs. One year later, all functionalities of OLM were
implemented in MarkUs.
