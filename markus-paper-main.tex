...
Since September 2010, MarkUs is now on the Github, a web-based hosting service
for software development projects that use the Git revision control system.
Github has an important role in the open-source community, as it permits to
share code easily among users. MarkUs now receive patches and improvements from
advanced users. 
%%% TO BE CORRECTED - end
